...
class DatabaseManager {
  ...
  getDefaultSettings() {
    return [
      ...
      ["layout_font_size_normal", "12px", "Normale Schriftgröße"],
      ["layout_font_size_small", "10px", "Kleine Schriftgröße für Details"],
      ["layout_font_size_large", "14px", "Große Schriftgröße für Beträge"],
      ["layout_font_size_h1", "22px", "Schriftgröße für Hauptüberschriften"],
      ["layout_font_size_h2", "18px", "Schriftgröße für Unterüberschriften"],
      [
        "layout_font_size_h3",
        "16px",
        "Schriftgröße für kleinere Überschriften",
      ],
      ["layout_line_height", "1.3", "Zeilenhöhe für bessere Lesbarkeit"],
